document.addEventListener("DOMContentLoaded", function(event) { 
  ...
  const content = [{ 
      ...
      altText: "Stylish white chairs and table with a bonsai tree on top."
    },
    { 
      ...
      altText: "3 modern looking dining chairs with varying colours"
    },
    { 
      ...
      altText: "black folding chair on a grey background"
    }];
  console.log(content);
  ...
  const addContent = (i) => {
    ...
    setTimeout(() => {
      ...
      imageContainer.alt = content[i].altText;
      imageMobileContainer.alt = content[i].altText;
